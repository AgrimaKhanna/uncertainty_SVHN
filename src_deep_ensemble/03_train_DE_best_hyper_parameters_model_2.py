...
for size in sample_sizes:
    ...
    print(f"\nTraining model with {size} samples per class model 2...")
    ...
    for model in ensemble.models:
        model_path = f"{model_dir}/svhn_model_{size}_samples_de_{ens_count}_model_2.pth"
    ...
    # Save the results
    results_path = f"./results_per_model/svhn_results_{size}_samples_model_2.json"
