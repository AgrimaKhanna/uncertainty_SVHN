...
for size in sample_sizes:
    ...
    # Train the model
    ensemble.train(trainloader, criterion, optimizers, epochs=95, device=device)
    ...
    for model in ensemble.models:
        model_path = f"{model_dir}/svhn_model_{size}_samples_de_{ens_count}.pth"
    ...
    # Save the results
    results_path = f"./results/svhn_results_{size}_samples.json"
